  ...
  return (
    <div className="PortfolioDetail">
      ...
      <div className="PortfolioDetail__grid">
        <div className="portfolio__info">
          ...
          <div className="tag-area">
            ...
            <p className="tags">React / CSS </p>
          </div>
          <a href={project.website} className="btn btn--alt" target="_blank">
            Visit Website
          </a>
        </div>
      ...
      <div className="other-projects">
        <Link
          className="other-projects__left"
          to={`/portfolio/${project.previous}`}
        >
          <ArrowLeft />
        ...
        <Link
          className="other-projects__right"
